...
class DeleteAccountManager {
    ...
    checkAndDelete = async (user) => {
        try {
            ...
            const expireDate = new Date(user.creationDate.getTime() + this.daysToExpire * 24 * 60 * 60 * 1000)
    ...
    constructor() {
        ...
        console.log('Checking expired accounts to delete. Days to expire:', this.daysToExpire)
