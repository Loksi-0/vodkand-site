...
function Index() {
  const accordionList = [
      ...
      },
      {
        ...
        content: 'Платная проходка нужна в первую очередь как защита от гриферов. При этом мы держим цену минимально низкой, чтобы вход оставался доступным для нормальных игроков'
      }
  ]
